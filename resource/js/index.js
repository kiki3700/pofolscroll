...
for(let i = 0; i<arr.length; i++){
    arr[i].addEventListener("click",function(){
        ...
        //window.scrollTo(0,-window.innerHeight/4+arr1[i].getBoundingClientRect().top)
        console.log("내부높이 : "+window.innerHeight/4);
        console.log("페이지 오프셋 : "+window.pageYOffset);
        console.log("arr i : "+arr1[i].getBoundingClientRect().top);
    })
}
